                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-xxl-8">
                        <div class="text-center my-5">
                            <h2 class="display-5 fw-bolder"><span class="text-gradient d-inline">About Sidesa</span>
                            </h2>
                            <p class="lead fw-light mb-4">Sidesa merupakan website untuk warga melihat riwayat tabungan
                                mereka.</p>
